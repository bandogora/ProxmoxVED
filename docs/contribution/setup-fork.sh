...
git remote add upstream https://github.com/bandogora/ProxmoxVED.git
...
# upstream   https://github.com/bandogora/ProxmoxVED.git (fetch)
# upstream   https://github.com/bandogora/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/bandogora/ProxmoxVED"
echo ""
