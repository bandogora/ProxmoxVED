...
```bash
# 1. Fork on GitHub
# Visit: https://github.com/bandogora/ProxmoxVED → Fork (top right)
...
- **GitHub**: https://github.com/bandogora/ProxmoxVED
- **Issues**: https://github.com/bandogora/ProxmoxVED/issues
