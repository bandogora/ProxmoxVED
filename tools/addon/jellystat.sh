...
source <(curl -fsSL https://raw.githubusercontent.com/bandogora/ProxmoxVED/yugabytedb/misc/tools.func)
source <(curl -fsSL https://raw.githubusercontent.com/bandogora/ProxmoxVED/yugabytedb/misc/error_handler.func)
...
type=update bash -c "$(curl -fsSL https://raw.githubusercontent.com/bandogora/ProxmoxVED/yugabytedb/tools/addon/jellystat.sh)"
UPDATEEOF
