...
# Source: https://www.ory.com/kratos
...
msg_info "Creating Ory User"
addgroup ory
adduser -DH -s /sbin/nologin -G ory ory
msg_ok "Created Ory User"

msg_info "Installing Cloudflared"
ash <(wget --no-cache -qO- https://raw.githubusercontent.com/ory/meta/master/install.sh) -s -b /usr/local/bin kratos
